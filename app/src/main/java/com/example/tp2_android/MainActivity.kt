...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        etudiants.add(Etudiant("Baccouche","Mooza","M", arrayListOf(Presence("TP",true),Presence("Cours", false))))
        etudiants.add(Etudiant("Decock","Dali","M",arrayListOf(Presence("TP",true),Presence("Cours", true))))
